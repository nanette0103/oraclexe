...
UPDATE copy_emp
SET department_id = 50 --부서 번호 50으로 변경
...
TRUNCATE문
    ...
    DML문이 아니라 DDL문(데이터 정의어)이므로 쉽게 언두할 수 없습니다.
*/
...
INSERT INTO member(num, name, addr)VALUES(1, '피카츄', '태초마을');    
COMMIT;
INSERT INTO member(num, name, addr)VALUES(2, '라이츄', '태초마을');    
INSERT INTO member(num, name, addr)VALUES(3, '파이리', '태초마을');    
INSERT INTO member(num, name, addr)VALUES(4, '꼬부기', '태초마을');  
